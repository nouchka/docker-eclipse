...
RUN apt-get update && \
	DEBIAN_FRONTEND=noninteractive apt-get -yq install wget openjdk-7-jdk php5 php5-cli php5-xdebug git subversion libcanberra-gtk3-module curl lintian fakeroot && \
