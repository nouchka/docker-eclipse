...
if [ ! -f "$FLAG" ]; then
	...
	/opt/eclipse/eclipse -nosplash \
	  ...
	  -repository http://www.nodeclipse.org/updates/markdown/,http://download.eclipse.org/releases/mars/,http://nodj.github.io/AutoDeriv/update,http://p2.pdt-extensions.org,https://raw.githubusercontent.com/wakatime/eclipse-wakatime/master/update-site/ \
